...
public class ScreenShot {
 ...
 System.out.println(BASE_PATH);
        String fileNameToSaveTo = BASE_PATH + "/IPScreenShare.jpg";
    ...
    private void drawMousePointer(BufferedImage screenCapture) throws IOException, URISyntaxException {
        InputStream arrow = this.getClass().getResourceAsStream("/ipscreenshare/images/cursor_arrow.png");
 ...
 public static void PreviewImage(JLabel lblImage) throws URISyntaxException, MalformedURLException {
        ...
        Image image = toolkit.getImage(BASE_PATH + "/IPScreenShare.jpg");
